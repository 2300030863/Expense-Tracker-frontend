    ...
    <header className="bg-white shadow-sm border-b border-gray-200">
      <div className="flex items-center justify-between h-16 px-6">
        <div className="flex items-center">
          ...
          {isAdmin && (
            <span className="ml-3 px-2 py-1 bg-purple-100 text-purple-700 text-xs font-medium rounded-full flex items-center">
        ...
        <div className="relative">
          ...
          >
            <div className={`w-8 h-8 ${isAdmin ? 'bg-purple-600' : 'bg-primary-600'} rounded-full flex items-center justify-center`}>
