            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-3 top-2 text-gray-500">{getCurrencySymbol(user?.country || 'India')}</span>
                  <input
                    type="number"
                    step="0.01"
                    min="0.01"
              ...
              {formData.description && formData.amount && formData.recurrenceType && (
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="text-sm text-gray-700 space-y-1">
                    ...
                    <p><strong>Amount:</strong> {formatCurrency(formData.amount)} ({formData.type})</p>
